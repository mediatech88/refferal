...
<head>
    ...
    <title>@yield('title') | BPRBDP</title>
    <!-- plugins:css -->
    ...
    <link rel="stylesheet" href="{{ asset('admin-templatevendors/ti-icons/css/themify-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-templatejs/select.dataTables.min.css') }}">
